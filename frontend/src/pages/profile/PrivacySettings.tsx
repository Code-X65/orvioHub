      ...
      <div className="space-y-6">
        ...
        <div className="p-5 rounded-xs bg-white/5 border border-white/10 space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-start gap-3">
              <div className="w-10 h-10 rounded-xs bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-400 shrink-0">
            ...
            <Button
              ...
              className="bg-indigo-600 hover:bg-indigo-500 text-white text-xs px-4 shrink-0 flex items-center gap-1.5 self-start sm:self-center rounded-xs"
            >
              {isExporting ? (
                <>
          ...
          <div className="p-3 bg-black/40 rounded-xs border border-white/5 text-[11px] text-slate-400 space-y-1">
        ...
        <div className="p-5 rounded-xs bg-white/5 border border-white/10 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={idx} className="p-3 bg-black/40 rounded-xs border border-white/5 space-y-1">
        ...
        <div className="p-5 rounded-xs bg-white/5 border border-white/10 space-y-4">
          ...
          <div className="space-y-3">
            <label className="flex items-center justify-between p-3 rounded-xs bg-black/40 border border-white/5 hover:border-white/10 cursor-pointer">
              <div>
              ...
              <input
                ...
                className="accent-[#714b67] w-4 h-4 rounded-xs"
              />
            </label>
