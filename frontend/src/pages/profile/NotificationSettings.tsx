  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        <div className="p-5 rounded-xs bg-white/5 border border-white/10 space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xs bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400">
                <Shield className="w-4 h-4" />
              </div>
              <div>
                <h4 className="text-sm font-semibold text-white flex items-center gap-2">
                  <span>Security & Account Alerts</span>
                  <span className="text-[10px] font-mono text-emerald-400 bg-emerald-500/10 px-2 py-0.5 rounded-xs border border-emerald-500/20">
                    Mandatory
                  </span>
                </h4>
        ...
        <div className="p-5 rounded-xs bg-white/5 border border-white/10 space-y-4">
          <div className="flex items-center gap-3 border-b border-white/10 pb-3">
            <div className="w-9 h-9 rounded-xs bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-400">
          ...
          <div className="space-y-3 pt-1">
            <label className="flex items-center justify-between p-3 rounded-xs hover:bg-white/5 cursor-pointer transition-colors">
              <div>
              ...
              <input
                ...
                className="accent-[#714b67] w-4 h-4 rounded-xs cursor-pointer"
              />
            </label>
        ...
        <div className="p-5 rounded-xs bg-white/5 border border-white/10 space-y-4">
          <div className="flex items-center gap-3 border-b border-white/10 pb-3">
            <div className="w-9 h-9 rounded-xs bg-amber-500/10 border border-amber-500/20 flex items-center justify-center text-amber-400">
        ...
        <div className="p-5 rounded-xs bg-white/5 border border-white/10 space-y-4">
          <div className="flex items-center gap-3 border-b border-white/10 pb-3">
            <div className="w-9 h-9 rounded-xs bg-pink-500/10 border border-pink-500/20 flex items-center justify-center text-pink-400">
        ...
        <div className="pt-4 flex justify-end border-t border-white/10">
          <Button
            ...
            onClick={handleSave}
            disabled={isSaving}
            className="bg-[#714b67] hover:bg-[#88597c] text-white text-xs px-6 rounded-xs"
          >
            {isSaving ? (
              <>
