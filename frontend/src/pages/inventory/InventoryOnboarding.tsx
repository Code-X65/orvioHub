              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <CustomSelect
                    options={[
                      ...
                      { value: 'GHS', label: 'Ghanaian Cedi (GHS - ₵)', badge: '₵' },
                      { value: 'KES', label: 'Kenyan Shilling (KES - KSh)', badge: 'KSh' },
                    ]}
                    value={currency}
                ...
                <div className="space-y-1.5">
                  ...
                  <CustomSelect
                    ...
                    value={defaultUnit}
                    onChange={(val) => setDefaultUnit(val)}
                    searchable={false}
                  />
                </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <CustomSelect
                      options={[
                        ...
                        { value: 'stock_manager', label: 'Stock Manager (Inventory)' },
                        { value: 'store_admin', label: 'Store Admin (Full access)' },
                      ]}
                      value={staffRole}
