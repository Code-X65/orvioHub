...
export const AUDIT_EVENTS = {
  ...
  // Organization & Workspace Audit Events
  ORGANIZATION_CREATION_STARTED: 'organization.creation_started',
  WORKSPACE_CREATED: 'workspace.created',
  WORKSPACE_OWNER_ASSIGNED: 'workspace.owner_assigned',
  ...
  WORKSPACE_INVITATION_VIEWED: 'workspace.invitation_viewed',
