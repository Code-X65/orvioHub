            ...
            <form onSubmit={handleSendInvite} className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={(e) => setInviteProductKey(e.target.value)}
                    className="w-full h-10 px-3 rounded-sm bg-slate-950 border border-slate-800 text-xs text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
                  >
                    <option value="inventory">Inventory</option>
                    <option value="taskmanagement">Tasks</option>
                  </select>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    onChange={(e) => setInviteProductRole(e.target.value)}
                    className="w-full h-10 px-3 rounded-sm bg-slate-950 border border-slate-800 text-xs text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 cursor-pointer"
                  >
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full p-2.5 rounded-sm bg-slate-950 border border-slate-800 text-xs text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-800">
                <Button
                  ...
                  variant="outline"
                  onClick={() => setIsInviteModalOpen(false)}
                  className="border-slate-800 text-slate-300 text-xs rounded-sm cursor-pointer"
                >
                  Cancel
                </Button>
                <Button
                  ...
                  className="bg-indigo-600 hover:bg-indigo-500 text-white font-semibold text-xs rounded-sm flex items-center gap-1.5 shadow-md shadow-indigo-600/20 cursor-pointer"
                >
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-sm w-full shadow-2xl space-y-4 animate-in fade-in zoom-in-95">
            ...
            <div className="space-y-3">
              <div className="space-y-1">
                <label className="text-xs text-slate-400">Organization Role</label>
                <select
                  value={editRole}
                  onChange={(e) => setEditRole(e.target.value)}
                  className="w-full h-10 px-3 rounded-sm bg-slate-950 border border-slate-800 text-xs text-white cursor-pointer"
                >
                  <option value="member">Member</option>
                  <option value="admin">Admin</option>
                  <option value="viewer">Viewer</option>
              ...
              <div className="space-y-1">
                <label className="text-xs text-slate-400">Inventory Product Role</label>
                <select
                  value={editProductRole}
                  onChange={(e) => setEditProductRole(e.target.value)}
                  className="w-full h-10 px-3 rounded-sm bg-slate-950 border border-slate-800 text-xs text-white cursor-pointer"
                >
                  <option value="sales_attendant">Sales Attendant</option>
                  <option value="stock_manager">Stock Manager</option>
            ...
            <div className="flex items-center justify-end gap-2 pt-3 border-t border-slate-800">
              ...
              <Button
                ...
                className="bg-indigo-600 text-xs rounded-sm cursor-pointer"
              >
