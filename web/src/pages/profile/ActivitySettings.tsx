              ...
              >
                <div className="flex items-start gap-3.5">
                  ...
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      {item.isSuspicious && (
                        <span className="text-[10px] font-mono font-medium px-2 py-0.5 rounded bg-rose-500/20 text-rose-300 border border-rose-500/30">
                          Marked Suspicious
                        </span>
                      )}
                    </div>
                ...
                {!item.isSuspicious && (
                  <Button
                    ...
                    className="border-white/10 bg-transparent text-slate-400 hover:text-rose-400 hover:bg-rose-950/20 text-xs shrink-0 self-end sm:self-center"
                  >
