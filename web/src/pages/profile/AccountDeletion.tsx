  ...
  return (
    ...
    >
      <div className="space-y-8 max-w-2xl">
          ...
          <div className="p-5 rounded-2xl bg-rose-950/30 border border-rose-500/40 space-y-3">
            ...
            <div className="space-y-1 pt-1">
              {ownedWorkspacesBlocker.map((ws: any, idx: number) => (
                <div key={idx} className="p-2 bg-black/40 rounded border border-white/5 text-xs text-white font-medium">
        ...
        {/* Deletion Form */}
        {!activeDeletionRequest && (
          <form onSubmit={handleScheduleDeletion} className="space-y-5 p-5 rounded-2xl bg-rose-950/10 border border-rose-900/30">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="bg-black/60 border-white/10 text-white focus:border-rose-500"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className="bg-black/60 border-white/10 text-white focus:border-rose-500 font-mono text-xs"
              />
            </div>
            ...
            <div className="pt-2">
              <Button
                ...
                className="w-full bg-rose-600 hover:bg-rose-700 text-white text-xs font-medium py-2.5"
              >
                {isSubmitting ? (
                  <>
