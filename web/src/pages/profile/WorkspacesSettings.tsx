      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/10">
          ...
          <Button
            ...
            className="bg-[#714b67] hover:bg-[#88597c] text-white text-xs shrink-0 flex items-center gap-1.5 cursor-pointer"
          >
            ...
            {workspaces.map((ws) => {
              ...
              return (
                <div
                  ...
                  className="p-5 rounded-xl bg-white/5 border border-white/10 hover:border-white/20 transition-all flex flex-col md:flex-row md:items-center justify-between gap-4"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#714b67] to-indigo-800 flex items-center justify-center text-white font-bold text-lg shrink-0">
                    ...
                    <div className="space-y-1.5">
                      <div className="flex flex-wrap items-center gap-2.5">
                        ...
                        <span className="text-[10px] font-mono px-2 py-0.5 rounded-full bg-white/10 text-slate-300 capitalize">
                  ...
                  <div className="flex items-center gap-2.5 pt-2 md:pt-0 border-t md:border-t-0 border-white/5">
                    <Button
                      ...
                      className="bg-white/10 hover:bg-white/20 text-white text-xs flex items-center gap-1 cursor-pointer"
                    >
                      <span>Open</span>
            ...
            {workspaces.length === 0 && (
              <div className="text-center py-12 border border-dashed border-white/10 rounded-xl space-y-3">
                ...
                <Button
                  size="sm"
                  onClick={() => navigate('/workspaces/new')}
                  className="bg-[#714b67] hover:bg-[#88597c] text-white text-xs cursor-pointer"
                >
